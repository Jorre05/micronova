...
You have to build a simple circuit to interface with your stove (see documentation preview for the details. You can also order a board from @philibertc, that should make it dead easy.

## Example configuration

The hardest part is to configure the correct IO pins for the UART and the enable_rx. 
Users have reported that when you got the interface board from @philibertc, then the pin-config below should work:
